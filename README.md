...
| gcp\_oauth\_accounts | n/a | <pre>map(object({<br>    oauth = object({<br>      audience = string<br>      ids = object({<br>        authnz            = string<br>        axon_server       = string<br>        workspace_manager = string<br>        workflow_manager  = string<br>      })<br>    })<br>  }))</pre> | <pre>{<br>  "dev": {<br>    "oauth": {<br>      "audience": "aws_workbench_dev",<br>      "ids": {<br>        "authnz": "116303836342211387450",<br>        "axon_server": "115222078872295738259",<br>        "workflow_manager": "102937181090438264814",<br>        "workspace_manager": "114909651314496481017"<br>      }<br>    }<br>  },<br>  "devel": {<br>    "oauth": {<br>      "audience": "aws_terra_devel",<br>      "ids": {<br>        "authnz": "109779806118261264215",<br>        "axon_server": "115222078872295738259",<br>        "workflow_manager": "116230365760589687692",<br>        "workspace_manager": "103839170783841758891"<br>      }<br>    }<br>  },<br>  "prod": {<br>    "oauth": {<br>      "audience": "aws_workbench_prod",<br>      "ids": {<br>        "authnz": "104230373849889301972",<br>        "axon_server": "103709590145107260341",<br>        "workflow_manager": "113928377999013167748",<br>        "workspace_manager": "106070837874473815265"<br>      }<br>    }<br>  },<br>  "test": {<br>    "oauth": {<br>      "audience": "aws_workbench_test",<br>      "ids": {<br>        "authnz": "109450723473110461688",<br>        "axon_server": "112598271154440002464",<br>        "workflow_manager": "110770441947027683471",<br>        "workspace_manager": "105660334668002635897"<br>      }<br>    }<br>  }<br>}</pre> | no |
